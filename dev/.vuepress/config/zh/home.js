export const home = {
    ...
    features: {
        components: {
            title: '组件驱动',
            subTitle: '开箱即用',
            description: '地图帮 是基于 Qt 的 Fluent Design 风格组件库。该组件库同时支持 C++ 和 Python，包含了数百个现成的组件和示例供你选择，保证能让你找到一个完美的组件作为千里之行的起点。',
            url: '/zh/pages/components/button/'
        },
        designer: {
            title: '拖拖拽拽',
            subTitle: '上手很快',
            description: '地图帮 充分利用了所见即所得的 QtDesigner 插件功能，将令人脑壳疼的复杂界面搭建任务转化为简单的积木游戏，即便是小白也能轻松上手！',
